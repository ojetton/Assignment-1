...
```
The data I have chosen for this comes from Federal Reserve Economic Data, and the tq_get() command allows me to grab data sets straight from the website. The datasets I have collected are, in order, the exchange rates of one Japanese Yen, one Chinese Yuan, one Canadian Dollar, one South Korean Won, and one Mexican New Peso to one U.S. dollar. All of the data is daily, and I selected the data after January 1st, 2001.
